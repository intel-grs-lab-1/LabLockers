...
class desktopController extends Controller
{
    ...
    public function handleImportLaptop(Request $request)
    {
        ...
        return view('Desktop.insertDesktop', compact('laptop','laptops','colors', 'types', 'powerSupplys', 'screenSizes', 'thunderboltPorts', 'touchscreens'));
    }
    ...
    public function editCsv($id)
    {
        ...
        return view('Desktop.edit', compact('laptop','laptops','colors', 'types', 'powerSupplys', 'screenSizes', 'thunderboltPorts', 'touchscreens'));
    }
    ...
    public function insertImportData(Request $request)
    {
        ...
        return redirect()->route('viewallDesktop')->with('success', 'Desktop imported successfully');
    }
