...
<div class="card uper">
  ...
  <div class="card-body">
    ...
    @endif
        <form method="POST" name="updateCsvData" action="{{ url('/desktopimport/updatedata', $laptop->id) }}">
        @csrf
        <form method="POST" name="updateCsvData" action="{{ url('/desktopimport/insertdata') }}">
        @csrf
